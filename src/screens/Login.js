            ...
            <ScrollView>
                ...
                <View style={styles.box}>
                    ...
                    <View className="flex-col justify-end" style={{ height: hp(45) }}>
                        <Image className="mt-8" style={styles.display} source={require('../../assets/images/display.png')} />
                    </View>
                    <View style={{ height: hp(10) }}>
                    </View>
                </View>

                <View className="flex-col items-center mt-12 justify-between" style={{ height: hp(40) }}>
                    ...
                    <View className="flex-row items-center mt-8" style={{width: wp(85)}}>
                    ...
                    <TouchableOpacity className="bg-[#32959D] rounded-full py-3 mt-8 items-center" style={{ height: hp(7), width: wp(80) }}>
                        <Text className="text-[22.48px] text-white">
                            Verify OTP
                        </Text>
                    </TouchableOpacity>
                </View>
